...
!////////////////////////////////////////////////////////////////////////
!
      SUBROUTINE UniformFlowStateWithPerturbation( x, t, Q )
      USE SMConstants
      USE PhysicsStorage
      IMPLICIT NONE
      ...
      Q(1) = 1.0_RP + 0.1_RP*EXP(2._RP*(-(x(1)-0.5_RP)**2 - (x(2)-0.5_RP)**2 - (x(3)-1.5_RP)**2))
      p    = 1.0_RP/(gammaM2)
      Q(2) = Q(1)*u
      Q(3) = Q(1)*v
      Q(4) = Q(1)*w
      ...
      END SUBROUTINE UniformFlowStateWithPerturbation
!
!////////////////////////////////////////////////////////////////////////
!
