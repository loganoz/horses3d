...
BoundaryConditions.o : ../../../Tests/Euler/PeriodicFlow/BoundaryConditions.f90 \
Physics.o \
MeshTypes.o \
SMConstants.o \
HexElementClass.o \
SharedBCModule.o \
Physics.o
	$(F90) -c $(FFLAGS) $(INCLUDES) -o $@ ../../../Tests/Euler/PeriodicFlow/BoundaryConditions.f90
...
PlotterDataSource.o : ../../../Tests/Euler/PeriodicFlow/PlotterDataSource.f90 \
SMConstants.o
	$(F90) -c $(FFLAGS) $(INCLUDES) -o $@ ../../../Tests/Euler/PeriodicFlow/PlotterDataSource.f90

ProblemFile.o : ../../../Tests/Euler/PeriodicFlow/ProblemFile.f90 \
Physics.o \
Physics.o \
BoundaryConditions.o \
MeshTypes.o \
...
SMConstants.o \
DGSEMClass.o
	$(F90) -c $(FFLAGS) $(INCLUDES) -o $@ ../../../Tests/Euler/PeriodicFlow/ProblemFile.f90
