...
!
!           -----------------------------------------------------------------------------------------
!           Expected solutions. The N=7 results are for cfl = 0.1 rather than 0.2 so iterations and
!           residuals won't match if that is changed. Errors should be OK.
!           -----------------------------------------------------------------------------------------
!
!           Inflow/Outflow on all boundaries
!            INTEGER                            :: iterations(3:7) = [6116, 2502, 1912, 3133, 2629]
!            REAL(KIND=RP), DIMENSION(3:7)      :: errors = [2.4532424598106006E-004, 5.0712502686955929E-005, &
!                                                            1.4294119336066835E-005, 4.5719434372815115E-006, &
!                                                            1.4176053452219506E-006]
!            REAL(KIND=RP), DIMENSION(3:7)      :: residuals = [9.9907742426915704E-011, 9.9657556468818124E-011, &
!                                                               9.9412973158238255E-011, 9.9598359193406744E-011, &
!                                                               9.9350524537717149E-011]
            
!
!           ----------------------------
!           Wall conditions on the sides
!           ----------------------------
!
            INTEGER                            :: iterations(3:7) = [6116, 3733, 2735, 2304, 3936]
            ...
            REAL(KIND=RP), DIMENSION(3:7)      :: residuals = [9.8416686811166881E-011, 9.4493299121877877E-011, &
                                                               9.7945502064983874E-011, 9.9049404715195391E-011, &
                                                               9.7419465483585806E-011]
!
            N = sem % spA % N
...
!     in the DoUserSetup routine at the beginning
!     of the computation.
!     -------------------------------------------
!
      success = .TRUE.
