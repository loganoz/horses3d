...
#
F90 = ifort
FTOLibPath = /Users/grubio/Universidad/Research/FortranCode/LibrarySource/FTObjectLibrary/Source
# end
FFLAGS = -O  -openmp
##########################
...
BoundaryConditions.o : ../../../Tests/NavierStokes/FlatPlate/BoundaryConditions.f90 \
Physics.o \
MeshTypes.o \
SMConstants.o \
HexElementClass.o \
SharedBCModule.o \
Physics.o
	$(F90) -c $(FFLAGS) $(INCLUDES) -o $@ ../../../Tests/NavierStokes/FlatPlate/BoundaryConditions.f90
...
PlotterDataSource.o : ../../../Tests/NavierStokes/FlatPlate/PlotterDataSource.f90 \
SMConstants.o
	$(F90) -c $(FFLAGS) $(INCLUDES) -o $@ ../../../Tests/NavierStokes/FlatPlate/PlotterDataSource.f90

ProblemFile.o : ../../../Tests/NavierStokes/FlatPlate/ProblemFile.f90 \
Physics.o \
Physics.o \
BoundaryConditions.o \
MeshTypes.o \
...
SMConstants.o \
DGSEMClass.o
	$(F90) -c $(FFLAGS) $(INCLUDES) -o $@ ../../../Tests/NavierStokes/FlatPlate/ProblemFile.f90
