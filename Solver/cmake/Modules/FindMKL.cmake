# CMake script for finding MKL for HORSES3D (dynamic linking, Fortran)
# Modified from elmer script by Andrés Rueda
...
IF (NOT UNIX)
  ...
  ENDIF()
  MESSAGE(FATAL_ERROR "Finding MKL libraries for HORSES3D not yet implemented for other platforms than Linux.")
ENDIF()
...
ELSEIF(${CMAKE_Fortran_COMPILER_ID} MATCHES "Intel")
 ...
 SET(MKL_Fortran_FLAGS "-mkl" CACHE STRING "MKL Fortran flags")
