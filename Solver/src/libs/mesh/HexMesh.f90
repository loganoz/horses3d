...
!     ---------------------
   ...
   subroutine HexMesh_CreateDeviceData(self)
      ...
      do iFace = 1, size(self % faces)
         ...
         !$acc enter data copyin(self % faces(iFace) % storage(1) % wallNodeDistance)
         !$acc enter data copyin(self % faces(iFace) % storage(2) % wallNodeDistance)
   ...
   subroutine HexMesh_ExitDeviceData(self)
      ...
      do iFace = 1, size(self % faces)
         ...
         !$acc exit data delete(self % faces(iFace) % storage(1) % wallNodeDistance)
         !$acc exit data delete(self % faces(iFace) % storage(2) % wallNodeDistance)
