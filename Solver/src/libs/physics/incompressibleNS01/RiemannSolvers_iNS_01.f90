#include "Includes.h"
module RiemannSolvers_iNS_01KeywordsModule
...
end module RiemannSolvers_iNS_01KeywordsModule
!
!////////////////////////////////////////////////////////////////////////
!
module RiemannSolvers_iNS_01
   use SMConstants
   use Physics_iNS_01
   use PhysicsStorage_iNS_01
   use VariableConversion_iNS_01
...
!        -------
         ...
         use RiemannSolvers_iNS_01KeywordsModule
!
!        ---------
!        Interface
!        ---------
...
!        *********************************************************************
!
         use Physics_iNS_01, only: iEulerXFlux
         implicit none
         real(kind=RP), intent(in)       :: QLeft(1:NCONS)
         real(kind=RP), intent(in)       :: QRight(1:NCONS)
         real(kind=RP), intent(out)      :: f(1:NCONS), g(1:NCONS), h(1:NCONS)
...
end module RiemannSolvers_iNS_01