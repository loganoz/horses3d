...
!
         ...
         logical                         :: saveGradients, saveMuAvg
!
!        Setup the buffer
!        ----------------
...
!        ----------
         ...
         saveMuAvg        = controlVariables % logicalValueForKey("save average mu")
         call Monitors % stats     % Construct(mesh, saveGradients, saveMuAvg)
