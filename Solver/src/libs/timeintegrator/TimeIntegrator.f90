...
character(len=*), parameter   :: SPLIT_TIME_STEPS_SOLVER   = 'split time steps'
!
!     ========
CONTAINS
!     ========
...
!     ////////////////////////////////////////////////////////////////////////////////////////
!
SUBROUTINE Integrate( self, sem, controlVariables, monitors, ComputeTimeDerivative,  &
#if defined(SCALAR_INS_V04)
               ComputeTimeDerivative_Second,  &  
               ComputeTimeDerivative_Third,  &  
               ComputeNonlinearStep1  ,       &    
#endif
...
#if defined(SCALAR_INS_V04)
procedure(ComputeNonlinearStep1_f), optional     :: ComputeNonlinearStep1
procedure(ComputeNonlinearStep1_f), optional     :: ComputeTimeDerivative_Second
procedure(ComputeNonlinearStep1_f), optional     :: ComputeTimeDerivative_Third
#endif
...
!  ------------------------------------------------------------------------
subroutine IntegrateInTime( self, sem, controlVariables, monitors, ComputeTimeDerivative, &
...
#endif
ComputeTimeDerivativeIsolated,                   &
tolerance, CTD_linear, CTD_nonlinear)
...
#if defined(SCALAR_INS_V04)
type(SplitStepsIntegrator_t)  :: SplitStepsIntegrator
#endif
...
#if defined(SCALAR_INS_V04)
case(SPLIT_TIME_STEPS_SOLVER)
   call SplitStepsIntegrator % construct(controlVariables,sem)
#endif
...
#if defined(SCALAR_INS_V04)
   CASE (SPLIT_TIME_STEPS_SOLVER)
      call SplitStepsIntegrator % TakeSplit_3_Steps (sem, t , dt , ComputeTimeDerivative, &
                     ComputeTimeDerivative_Second,ComputeTimeDerivative_Third, ComputeNonlinearStep1 &
                     , K, FirstStep, SecondStep)
   FirstStep = .FALSE.
#endif
...
#if defined(SCALAR_INS_V04)
case(SPLIT_TIME_STEPS_SOLVER)
   call SplitStepsIntegrator % destruct
#endif
