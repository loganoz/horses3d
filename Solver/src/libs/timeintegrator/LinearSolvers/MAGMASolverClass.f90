...
MODULE MAGMASolverClass
   ...
   TYPE, EXTENDS(GenericLinSolver_t) :: MAGMASolver_t
   ...
   CONTAINS
      !Subroutines:
      PROCEDURE :: construct                    => ConstructMAGMASolver
      procedure :: ComputeAndFactorizeJacobian  => MAGMA_ComputeAndFactorizeJacobian
      procedure :: ReFactorizeJacobian          => MAGMA_ReFactorizeJacobian
      PROCEDURE :: solve
      procedure :: SolveLUDirect                => MAGMA_SolveLUDirect
      procedure :: SetRHSValue                  => MAGMA_SetRHSValue
      procedure :: SetRHS                       => MAGMA_SetRHS
      PROCEDURE :: GetXValue                    => MAGMA_GetXValue
      PROCEDURE :: GetX                         => MAGMA_GetX
      PROCEDURE :: destroy                      => MAGMA_destroy
      PROCEDURE :: SetOperatorDt
      PROCEDURE :: ReSetOperatorDt
      procedure :: MAGMA_ComputeJacobian
      procedure :: FactorizeJacobian            => MAGMA_FactorizeJacobian
      procedure :: SetJacobian                  => MAGMA_SetJacobian
      !Functions:
      PROCEDURE :: Getxnorm                     => MAGMA_GetXnorm    !Get solution norm
      PROCEDURE :: Getrnorm    !Get residual norm
   END TYPE MAGMASolver_t
   
   private
   public MAGMASolver_t, GenericLinSolver_t
...
!  -----------------------
   subroutine ConstructMAGMASolver(this,DimPrb, globalDimPrb, nEqn,controlVariables,sem,MatrixShiftFunc)
      implicit none
      !-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout), TARGET :: this
      ...
      if (MPI_Process % doMPIRootAction) then
         ERROR stop 'MAGMASolver_t cannot be used as a distributed solver'
      end if
...
!        ------------------------------------------------------------------------------
   ...
   end subroutine ConstructMAGMASolver
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_SetRHSValue(this, irow, value)
      implicit none
      !-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout) :: this
   ...
   end subroutine MAGMA_SetRHSValue
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_SetRHSValues(this, nvalues, irow, values)
      class(MAGMASolver_t)   , intent(inout)     :: this
   ...
   end subroutine MAGMA_SetRHSValues
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_SetRHS(this, RHS)
      implicit none
      !-arguments-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout) :: this
...
!
      !-----------------------------------------------------------
      class(MAGMASolver_t), target, intent(inout) :: this
      integer,       intent(in)                :: nEqn
...
!     -----------------------------------------------------
      ...
      if ( present(ComputeA)) then
         if (ComputeA) then
            call this % MAGMA_ComputeJacobian(dt,time,nEqn,nGradEqn,ComputeTimeDerivative)
            ComputeA = .FALSE.
         end if
      else
         call this % MAGMA_ComputeJacobian(dt,time,nEqn,nGradEqn,ComputeTimeDerivative)
...
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_ComputeJacobian(this,dt,time,nEqn,nGradEqn,ComputeTimeDerivative)
...
!~         !debug>
   ...
   end subroutine MAGMA_ComputeJacobian
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_GetXValue(this,irow,x_i)       
      implicit none
      !-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout) :: this
      INTEGER                  , intent(in)    :: irow
   ...
   end subroutine MAGMA_GetXValue
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   function MAGMA_GetX(this) result(x)
      IMPLICIT NONE
      !-----------------------------------------------------------
      CLASS(MAGMASolver_t), INTENT(INOUT) :: this
   ...
   end function MAGMA_GetX
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_destroy(this)       
      implicit none
      !-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout) :: this
      !-----------------------------------------------------------
...
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   function MAGMA_GetXnorm(this,TypeOfNorm) result(xnorm)
      implicit none
      !-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout) :: this
...
!
   ...
   subroutine MAGMA_ComputeAndFactorizeJacobian(self,nEqn, nGradEqn, F_J, dt, eps, mode_in)
!
!     *************************************************************************************
...
!
      implicit none
      class(MAGMASolver_t), intent(inout) :: self
   ...
   end subroutine MAGMA_ComputeAndFactorizeJacobian

   subroutine MAGMA_ReFactorizeJacobian(self) 
! 
!     ************************************************************************************* 
...
! #endif 
   ...
   end subroutine MAGMA_ReFactorizeJacobian 

!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_FactorizeJacobian(self)
      implicit none
      !-arguments---------------------------------------------------
      class(MAGMASolver_t), intent(inout)  :: self
      !-local-variables---------------------------------------------
...
! #endif
   ...
   end subroutine MAGMA_FactorizeJacobian
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_SolveLUDirect(self,error_out)
      implicit none
      class(MAGMASolver_t), intent(inout)  :: self
...
! #endif
   ...
   end subroutine MAGMA_SolveLUDirect
!
!///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
!
   subroutine MAGMA_SetJacobian(this,Matrix)
      implicit none
      !-arguments-----------------------------------------------------------
      class(MAGMASolver_t), intent(inout)  :: this
      ...
      class is(csrMat_t)
         this % A = Matrix
      class default
         ERROR stop 'MAGMA_SetJacobian :: Wrong matrix type'
      end select
      
   end subroutine MAGMA_SetJacobian
END MODULE MAGMASolverClass
