...
!        Solver construction
!        ---------------------
         call Solver % linsolver % construct(Solver % p_sem % NDOF*NTOTALVARS, Solver % p_sem % totalNDOF*NTOTALVARS, NTOTALVARS, controlVariables, Solver % p_sem, BDF_MatrixShift)
