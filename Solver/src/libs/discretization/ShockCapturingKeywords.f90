...
!  ----------------
   ...
   character(len=*), parameter :: SC_MACH_V_VAL    = "mach"
   character(len=*), parameter :: SC_MACH_N_V_VAL  = "mach perp"
   ...
   integer, parameter :: SC_GRAD_P_ID    = 13
   ...
   integer, parameter :: SC_MACH_N_V_ID  = 18
   integer, parameter :: SC_GRAD_MACH_ID = 19
!
!  Derivative types
!  ----------------
