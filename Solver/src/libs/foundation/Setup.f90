...
!
      Module mainKeywordsModule
         ...
         CHARACTER(LEN=KEYWORD_LENGTH), PARAMETER :: saveGradientsToSolutionKey = "save solution with gradients"
         ...
         CHARACTER(LEN=KEYWORD_LENGTH), DIMENSION(9) :: mainKeywords =  [ meshFileNameKey,         &
