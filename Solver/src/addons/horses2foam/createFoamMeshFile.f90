!
! ////////////////////////////////////////////////////////////////////
!   HORSES3D to Foam Result - createFoamMeshFile Module
!
!      This module convert foamMeshStorage data into foamMesh files
!       foamMesh files consist of 'points', 'faces', 'owner', 'neighbour' and 'boundary files
!
!////////////////////////////////////////////////////////////////////////////////////////
!
MODULE createFoamMeshFile
    USE SMConstants
    USE storageFoam
    IMPLICIT NONE
