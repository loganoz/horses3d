PROGRAM HORSES3DMainSCALAR
    ...
    call SetSolver(SCALAR_INS_V04_SOLVER)
!
!     -----------------------------------------
...
!     -----------------
!
    CALL timeIntegrator%integrate(sem, controlVariables, sem%monitors, ComputeTimeDerivative, ComputeTimeDerivative_Second, ComputeTimeDerivative_Third, ComputeNonlinearStep1, ComputeTimeDerivativeIsolated)
    ! CALL timeIntegrator%integrate(sem, controlVariables, sem%monitors, ComputeTimeDerivative, ComputeTimeDerivative_Second, ComputeTimeDerivative_Third, ComputeNonlinearStep1, ComputeTimeDerivativeIsolated)
!

    ! CALL computeL2Error(sem%mesh)
!     ----------------------------------
