...
!
            ...
            real(kind=RP), parameter           :: residuals_saved(5) = [7.2798709505642E-01_RP, &
                                                                        4.14154086873044E+00_RP, &
                                                                        9.7885082257257918E-14_RP, &
                                                                        3.25837253137888E+00_RP, &
                                                                        1.5785049514620010E+02_RP]
            real(kind=RP), parameter           :: entropyRate_saved = -6.54222518444048E-03_RP
