...
!
            ...
            real(kind=RP), parameter :: residuals(5) = [ 4.4957200362140490E+00_RP, &
                                                         2.2524663213757840E+01_RP, &
                                                         1.0258416113693404E-012_RP, &
                                                         1.6115537770513988E+01_RP, &
                                                         1.3380362475600765E+02_RP]

            real(kind=RP), parameter           :: wake_u = 1.0000000000000084E+00_RP
            real(kind=RP), parameter           :: cd =  7.65720377203E-05_RP 
            real(kind=RP), parameter           :: cl =  6.2797232478957277E+01_RP
...
!
            ...
            CALL FTAssertEqual(expectedValue = cd + 1.0_RP, &
                               actualValue   = monitors % surfaceMonitors(1) % values(1) + 1.0_RP, &
                               tol           = 1.d-11, &
