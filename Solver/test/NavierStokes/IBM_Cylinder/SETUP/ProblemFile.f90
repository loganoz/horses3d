...
!           ---------------
!
            CHARACTER(LEN=29)                  :: testName           = "IBM Re 40 Cylinder"
...
!
#if defined(NAVIERSTOKES)
            INTEGER                            :: iterations(3:7) = [50, 0, 0, 0, 0]
 

 
            real(kind=RP), parameter :: residuals(5) = [ 2.2392780824612009D+03 , &
                                                         9.2558237144284521D+03 , &
                                                         8.2422891960639972D+03 , &
                                                         4.0293597403989352D+03 , &
                                                         1.1521972061218960D+05  ]
