...
!
            ...
            real(kind=RP), parameter  :: residuals(5) = [  6.2838924111412731E-01_RP, &
                                                           1.8880402299553984E+00_RP, &
                                                           2.5257816906017094E+00_RP, &
                                                           4.4137338696617938E+00_RP, &
                                                           2.5153751482782658E+00_RP]
            real(kind=RP), parameter :: entropyRate = 3.4973252274750376E-07_RP
            real(kind=RP), parameter :: saved_errors(5) =[ 6.7174769052792914E-06_RP, &
                                                           7.8936751849804373E-06_RP, &
                                                           2.8203611177044557E-06_RP, &
                                                           6.6884144365250127E-06_RP, &
                                                           1.4116624697295942E-05_RP]
            real(kind=RP), parameter :: saved_qdot_errors(5) =[ 1.2370219075207763E-04_RP, &
                                                                1.1813999720732922E-04_RP, &
                                                                4.0653170754839378E-05_RP, &
                                                                1.2358578587070169E-04_RP, &
                                                                2.1723315094097264E-04_RP]
