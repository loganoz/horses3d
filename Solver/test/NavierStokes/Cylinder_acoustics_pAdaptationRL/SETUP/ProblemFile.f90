...
!
!           -----------------------------------------------------------------
!           Number of iterations are for CFL of 0.8, for
!           the low dissipation roe solver, mach = 0.15 and RL p-adaptation each 50 iterations
!           -----------------------------------------------------------------
!
#if defined(NAVIERSTOKES)
            real(kind=RP), parameter :: residuals(5) = [ 8.6148446644161965E+00_RP, &
                                                         4.7551844950214218E+01_RP, &
                                                         3.7704383489975797E+01_RP, &
                                                         2.2489540352215767E-01_RP, &
                                                         9.4966662266413130E+02_RP]

            real(kind=RP), parameter             :: cd = 1.6055021738355826E+01_RP
            real(kind=RP), parameter             :: cl = 2.2512723502465803E-04_RP
