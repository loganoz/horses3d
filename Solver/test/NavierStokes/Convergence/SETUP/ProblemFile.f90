...
!
            ...
            real(kind=RP), parameter  :: residuals(5) = [  6.2801762330611588E-01_RP, &
                                                           1.8889640334957627E+00_RP, &
                                                           2.5256897695536247E+00_RP, &
                                                           4.4142472296503827E+00_RP, &
                                                           2.5163928650671146E+00_RP]

            real(kind=RP), parameter :: entropyRate = 8.7517056213126665E-08_RP
            real(kind=RP), parameter :: saved_errors(5) =[ 1.0983475326313417E-06_RP, &
                                                           1.4788256133056976E-06_RP, &
                                                           4.5499827613507929E-07_RP, &
                                                           9.0819927730318800E-07_RP, &
                                                           2.5402026557722347E-06_RP]
            real(kind=RP), parameter :: saved_qdot_errors(5) =[ 1.1342700947907287E-05_RP, &
                                                                1.1638989807665964E-05_RP, &
                                                                3.5549224957856481E-06_RP, &
                                                                1.0769093706709006E-05_RP, &
                                                                2.0658954210939997E-05_RP]
