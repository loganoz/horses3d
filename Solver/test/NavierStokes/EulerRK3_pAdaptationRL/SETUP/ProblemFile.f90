...
!           Number of iterations are for CFL of 0.15, for
!           the roe solver, mach = 0.2, BR1 viscous discretization,
!           Euler-RK3 hybrid temporal scheme and RL p-adaptation each 50 iterations
!           -----------------------------------------------------------------
!
#if defined(NAVIERSTOKES)
            INTEGER                            :: iterations(3:7) = [100, 0, 0, 0, 0]
  
            real(kind=RP), parameter :: residuals(5) = [ 1.5673633115614200E+01_RP, &
                                                         7.4580997800306989E+01_RP, &
                                                         4.9120028926252964E+01_RP, &
                                                         9.7624993911715996E-01_RP, &
                                                         9.7104969845589187E+02_RP]

            real(kind=RP), parameter           :: cd = 1.7846278867942637E+01_RP
