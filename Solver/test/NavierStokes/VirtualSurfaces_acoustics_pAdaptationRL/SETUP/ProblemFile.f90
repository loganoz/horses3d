...
!           -----------------------------------------------------------------------------------------
!           Expected solutions. 
!           wall 0.0 NoSlipAdiabaticWall
!           FARFIELD 0.0 Outflow
!           fix_p 0.0 Outflow
!           PERIODLEFT 0.0 Periodic
!           PERIODRIGHT 0.0 Periodic
!           -----------------------------------------------------------------------------------------
!
!
!           ------------------------------------------------
!           Expected Solutions: Acoustic path based on p-Adaptation and virtual surfaces
!           Number of iterations are for CFL of 0.1, for
!           the roe solver and mach = 0.2
!           ------------------------------------------------
!
#if defined(NAVIERSTOKES)
             INTEGER                            :: iterations(3:7) = [10, 0, 0, 0, 0]
 
             real(kind=RP), parameter :: residuals(5) = [ 9.7539428251830515E+01_RP, &
                                                          3.9435745411448971E+02_RP, &
                                                          1.4296798381890116E+02_RP, &
                                                          3.6759663606977993E-12_RP, &
                                                          5.6106720322543460E+03_RP]
