...
!
            ...
            CALL FTAssertEqual(expectedValue = 1.0_RP, &
                               actualValue   = 1.0_RP + monitors % surfaceMonitors(3) % values(1) + monitors % surfaceMonitors(4) % values(1), &
                               tol           = 1.0e-10_RP, &
                               msg           = "Lift")
            ...
            IF ( sharedManager % numberOfAssertionFailures() == 0 )     THEN
               ...
               WRITE(6,*) "                     1. The GMSH mesh has been read correctly."
               WRITE(6,*) "                     2. The symmetrical aerofoil lift is machine 0."
            ELSE
