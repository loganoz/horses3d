...
file_path = 'convergenceTest1103__GaussPoint_order10.txt'
...
# print(df)
file_pathPre = 'convergenceTest1103__GaussPoint_order'
...
for i in range(1, 11):
    ...
    try:
        ...
        plt.plot(df['dofsqrt'], slope,
                 ...
                 linewidth=0.6,  # Reduce the line width by a factor of three
...
plt.ylabel('relative error, Gauss point')
plt.title(r'$-\nabla^2 P = 8 \pi^2 sin(2 \pi x) sin(2 \pi z)$')
plt.legend(fontsize = 10)
plt.grid(True)
plt.savefig('readConvergences004_GaussPoint.png')