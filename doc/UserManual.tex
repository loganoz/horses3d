...
Nmax          & \textit{INTEGER}(3): Maximum polynomial order in each direction for the p-adaptation algorithm. & N \\ \hline
...
interval & 
			\textit{INTEGER}: In unsteady p-adaptation cases, this keyword specifies the iteration interval for p-adaptation. &
					\textit{huge} \\ \hline
