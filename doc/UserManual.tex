...
Shock sensor & \textit{CHARACTER}: Type of sensor to be used to detect discontinuous regions Options are:
    \begin{itemize}
        ...
        \item Truncation error: estimate the truncation error of the approximation (Incompatible with the subcell discretization)
...
Sensor skip steps & \textit{INTEGER}: Skip the computation of the sensor this number of time steps & 0 \\ \hline
\end{longtable}
