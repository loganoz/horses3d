...
By default, NoSlipWall is adiabatic. Isothermal wall can be activated by including the following keyword:

wall type (adiabatic/isothermal) = isothermal

In this case, wall temperature = value should be also included in the control file. It is also possible to set a moving wall with the keyword wall velocity = value. 
