...
mg smoother     & \textit{CHARACTER}: The smoothing technique to be used. It can be either RK3 (explicit pseudo time-stepping, i.e. no good for time-accurate simulations), BlockJacobi (implicit consistent time-stepping), or (matrix-free) GMRES (implicit consistent time-stepping). & RK3 \\ \hline
